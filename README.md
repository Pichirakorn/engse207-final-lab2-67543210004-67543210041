...
- ใน Set 1 เป็นการพัฒนาโครงสร้างระบบแบบ Microservices โดยประกอบด้วย 3 services หลัก ได้แก่
- Auth Service สำหรับจัดการการยืนยันตัวตน (Login / Register / JWT)
- User Service สำหรับจัดการข้อมูลผู้ใช้
- Task Service สำหรับจัดการข้อมูลงาน
- แต่ละ service แยก database ออกจากกัน (database per service) และสามารถทำงานได้ในระดับพื้นฐาน โดยมีการเตรียม Dockerfile สำหรับรันระบบ

Set 2

- ใน Set 2 เป็นการนำระบบจาก Set 1 มาต่อยอด โดยเพิ่มความสามารถด้านความปลอดภัยและการทำงานร่วมกันของ services ได้แก่
- เพิ่ม Role-based Authorization (admin / member) เพื่อควบคุมสิทธิ์การเข้าถึง
- เพิ่มการทำงานร่วมกันระหว่าง services (integration) เช่น การตรวจสอบ token จาก Auth Service ก่อนใช้งาน service อื่น
- เพิ่ม Rate Limiting เพื่อจำกัดจำนวน request
- เพิ่ม Logging สำหรับบันทึกการทำงานของระบบ
- เพิ่ม Security Test Cases สำหรับทดสอบความถูกต้องด้านความปลอดภัย
- นำระบบไป deploy เพื่อให้สามารถใช้งานได้จริง
